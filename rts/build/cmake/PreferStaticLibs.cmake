...
if (VCPKG_TOOLCHAIN AND MSVC)
	if (NOT PREFER_STATIC_LIBS)
		message(FATAL_ERROR "Static linking must be set for Windows executables. Run again with -DPREFER_STATIC_LIBS")
	endif()
endif()
...
if    (PREFER_STATIC_LIBS)
	...
	if(NOT MSVC)
		...
		set(CMAKE_CXX_FLAGS_RELWITHDEBUGINFO "${CMAKE_CXX_FLAGS_RELWITHDEBUGINFO} /MT")
	...
	macro    (FIND_PACKAGE_STATIC)
		prefer_static_libs()
		find_package(${ARGV0} ${ARGV1} ${ARGV2})
