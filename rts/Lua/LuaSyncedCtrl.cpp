...
int LuaSyncedCtrl::ShareTeamResource(lua_State *L)
{
	...
	case 'm':
	{
		...
		{ //FIXME can cause an endless loop
...
int LuaSyncedCtrl::SetProjectileTarget(lua_State *L)
{
	...
	case 3:
	{
		...
		break;
		case 'g':
		{ /* fall-through, needs four arguments (todo: or a table?) */
		}
		default:
		{ /* if invalid type-argument, current target will be cleared */
		}
		break;
		}
